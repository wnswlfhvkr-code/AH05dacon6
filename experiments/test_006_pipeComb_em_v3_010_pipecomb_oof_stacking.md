# test_006_pipeComb_em_v3_010

| 항목 | 결과 |
| --- | --- |
| 실행 시각 | 2026-08-06T10:02:42+09:00 |
...
| 과적합 격차 | 0.234496 |
| 과적합 여부 | True |
| 설정 파일 | `configs/test_006_pipeComb_em_v3_010.yaml` |
| 제출 파일 | `data/processed/test_006_pipeComb_em_v3_010_pipecomb_oof_stacking_submission.csv` |
| 모델 아티팩트 | `models/test_006_pipeComb_em_v3_010.pkl` |
