# test_006_pipeComb_em_v3_006

| 항목 | 결과 |
| --- | --- |
| 실행 시각 | 2026-08-05T23:59:10+09:00 |
| 모델 | pipecomb_oof_stacking |
| 전처리 파이프라인 | pipeComb_em_v3 |
| 선택된 최소 변이 횟수 | - |
| 학습 데이터 행 수 | 6201 |
| 피처 수 | 262730 |
| 최종 Macro F1 | 0.567234 |
| 80% 학습 Macro F1 | 0.804380 |
| 20% 검증 Macro F1 | 0.567234 |
| 과적합 격차 | 0.237147 |
| 과적합 여부 | True |
| 설정 파일 | `configs/test_006_pipeComb_em_v3_006.yaml` |
| 제출 파일 | `data/processed/test_006_pipeComb_em_v3_006_pipecomb_oof_stacking_submission.csv` |
| 모델 아티팩트 | `models/test_006_pipeComb_em_v3_006.pkl` |
...
jyp9_parameters:
  ...
  - - LGG
    - GBMLGG
  f7_top_k_per_direction: 2
  f7_min_gene_support: 15
  f7_laplace_alpha: 6.0
  f7_burden_quantiles: 5
  f7_stability_folds: 5
  f7_min_direction_consistency: 5
  f7_min_selection_frequency: 4
  f7_oof_folds: 5
  f7_random_state: 42
