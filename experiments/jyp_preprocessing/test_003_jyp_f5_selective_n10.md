# test_003_jyp_f5_selective_n10

| 항목 | 결과 |
| --- | --- |
| 실행 시각 | 2026-08-03T11:19:32+09:00 |
| 모델 | xgboost |
| 전처리 파이프라인 | jyp_f5_selective_no_raw |
| 선택된 최소 변이 횟수 | - |
| 학습 데이터 행 수 | 6201 |
| 피처 수 | 54657 |
| 검증 Macro F1 | 0.408814 |
| 설정 파일 | `configs\test_003.yaml` |
| 제출 파일 | `data\processed\test_003_jyp_f5_selective_n10_submission.csv` |
| 모델 아티팩트 | `models\test_003_jyp_f5_selective_n10.pkl` |
