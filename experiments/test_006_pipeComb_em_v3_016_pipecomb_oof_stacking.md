# test_006_pipeComb_em_v3_016

| 항목 | 결과 |
| --- | --- |
| 실행 시각 | 2026-08-06T12:34:01+09:00 |
| 모델 | pipecomb_oof_stacking |
| 전처리 파이프라인 | pipeComb_em_v3 |
| 선택된 최소 변이 횟수 | - |
| 학습 데이터 행 수 | 6201 |
| 피처 수 | 258591 |
| 최종 Macro F1 | 0.564446 |
| 80% 학습 Macro F1 | 0.809579 |
| 20% 검증 Macro F1 | 0.564446 |
| 과적합 격차 | 0.245132 |
| 과적합 여부 | True |
| 설정 파일 | `configs/test_006_pipeComb_em_v3_016.yaml` |
| 제출 파일 | `data/processed/test_006_pipeComb_em_v3_016_pipecomb_oof_stacking_submission.csv` |
| 모델 아티팩트 | `models/test_006_pipeComb_em_v3_016.pkl` |
