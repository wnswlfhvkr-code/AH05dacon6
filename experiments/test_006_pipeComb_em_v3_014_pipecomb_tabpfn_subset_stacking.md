# test_006_pipeComb_em_v3_014

| 항목 | 결과 |
| --- | --- |
| 실행 시각 | 2026-08-06T12:04:19+09:00 |
| 모델 | pipecomb_tabpfn_subset_stacking |
| 전처리 파이프라인 | pipeComb_em_v3 |
| 선택된 최소 변이 횟수 | - |
| 학습 데이터 행 수 | 6201 |
| 피처 수 | 258591 |
| 최종 Macro F1 | 0.544579 |
| 80% 학습 Macro F1 | 0.800467 |
| 20% 검증 Macro F1 | 0.544579 |
| 과적합 격차 | 0.255889 |
| 과적합 여부 | True |
| 설정 파일 | `configs/test_006_pipeComb_em_v3_014.yaml` |
| 제출 파일 | `data/processed/test_006_pipeComb_em_v3_014_pipecomb_tabpfn_subset_stacking_submission.csv` |
| 모델 아티팩트 | `models/test_006_pipeComb_em_v3_014.pkl` |
