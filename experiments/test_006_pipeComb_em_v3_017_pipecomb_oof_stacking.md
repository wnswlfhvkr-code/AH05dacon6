# test_006_pipeComb_em_v3_017

| 항목 | 결과 |
| --- | --- |
| 실행 시각 | 2026-08-06T13:57:25+09:00 |
...
| 과적합 격차 | 0.245132 |
| 과적합 여부 | True |
| 설정 파일 | `configs/test_006_pipeComb_em_v3_017.yaml` |
| 제출 파일 | `data/processed/test_006_pipeComb_em_v3_017_pipecomb_oof_stacking_submission.csv` |
| 모델 아티팩트 | `models/test_006_pipeComb_em_v3_017.pkl` |
