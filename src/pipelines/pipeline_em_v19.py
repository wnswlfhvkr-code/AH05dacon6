"""EM v16의 OOF signature와 EM v20의 안정 consequence를 결합한 EM v19."""
...
class EMV19PreprocessingPipeline(PreprocessingPipeline):
    """OOF signature·hotspot·안정 consequence를 중복 없이 결합합니다."""
    ...
    def fit(self, features: pd.DataFrame, labels: pd.Series) -> "EMV19PreprocessingPipeline":
        (
