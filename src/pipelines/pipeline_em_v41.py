"""em_v24와 em_v12을 중복 없이 결합한 EM v41."""
...
class EMV41PreprocessingPipeline(PreprocessingPipeline):
    """v12 severity·summary·signature를 중복 생성하지 않고 v24 흐름만 유지합니다."""
    ...
    def fit(self, features: pd.DataFrame, labels: pd.Series) -> "EMV41PreprocessingPipeline":
