"""em_v16과 em_v21을 중복 없이 결합한 과적합 완화 EM v28."""
...
class EMV28PreprocessingPipeline(PreprocessingPipeline):
    """v16 OOF signature에 v21의 차원·hotspot 과적합 완화를 결합합니다."""
    ...
    def fit(self, features: pd.DataFrame, labels: pd.Series) -> "EMV28PreprocessingPipeline":
        (
