...
class F2PreprocessingPipeline(PreprocessingPipeline):
    """F2PreprocessingPipeline의 단계 고정 전처리 구현입니다."""
    name = 'jyp_f2'
    ...
    def __init__(self, *, burden_clip_quantile: float=0.99, show_progress: bool=True, progress_interval: int=25000) -> None:
        ...
        self.feature_blocks = ('raw', 'f0', 'f1', 'f2')
    ...
    def fit(self, features: pd.DataFrame, labels: pd.Series | Sequence[str]) -> 'F2PreprocessingPipeline':
