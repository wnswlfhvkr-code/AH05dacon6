...
def build_f7_selected_gene_catalog(model: F7PairContrastModel) -> list[dict[str, object]]:
    ...
    return catalog
class F9GlobalAAPairNoRawPreprocessingPipeline(PreprocessingPipeline):
    """F7 우승 후보에 전역 아미노산 치환쌍 count를 더한 F9 구현입니다."""
    name = 'jyp_f9'
