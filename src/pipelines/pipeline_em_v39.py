"""em_v24와 em_v6을 중복 없이 결합한 EM v39."""
...
class EMV39PreprocessingPipeline(PreprocessingPipeline):
    """v6의 consequence·burden이 이미 포함되어 v24의 세분화된 dual 흐름만 유지합니다."""
    ...
    def fit(self, features: pd.DataFrame, labels: pd.Series) -> "EMV39PreprocessingPipeline":
