"""em_v16과 em_v6의 중복을 제거해 단일 흐름으로 만든 EM v31."""
...
class EMV31PreprocessingPipeline(PreprocessingPipeline):
    """v6 기능이 이미 포함된 v16 severity·summary·OOF·hotspot을 유지합니다."""
    ...
    def fit(self, features: pd.DataFrame, labels: pd.Series) -> "EMV31PreprocessingPipeline":
