"""em_v15의 outer OOF와 em_v16의 inner signature OOF를 정리한 EM v38."""
...
class EMV38PreprocessingPipeline(PreprocessingPipeline):
    """outer 평가 OOF와 inner signature OOF를 중복 없이 서로 다른 단계에 적용합니다."""
    ...
    def fit(self, features: pd.DataFrame, labels: pd.Series) -> "EMV38PreprocessingPipeline":
