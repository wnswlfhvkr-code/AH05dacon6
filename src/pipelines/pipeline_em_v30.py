"""em_v16과 em_v5를 중복 없이 결합한 EM v30."""
...
class EMV30PreprocessingPipeline(PreprocessingPipeline):
    """v16 피처에 전체 입력 유전자 기준 burden total/rate만 추가합니다."""
    ...
    def fit(self, features: pd.DataFrame, labels: pd.Series) -> "EMV30PreprocessingPipeline":
