"""em_v16과 em_v11을 중복 없이 결합한 EM v34."""
...
class EMV34PreprocessingPipeline(PreprocessingPipeline):
    """중복 이진·signature를 제외하고 v11의 전체 입력 burden만 추가합니다."""
    ...
    def fit(self, features: pd.DataFrame, labels: pd.Series) -> "EMV34PreprocessingPipeline":
