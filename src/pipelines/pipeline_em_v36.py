"""em_v16과 em_v13을 중복 없이 결합한 EM v36."""
...
class EMV36PreprocessingPipeline(PreprocessingPipeline):
    """v13 중복을 제외하고 전체 입력 burden total/rate만 v16에 추가합니다."""
    ...
    def fit(self, features: pd.DataFrame, labels: pd.Series) -> "EMV36PreprocessingPipeline":
