"""inner-fold OOF 암종 signature를 적용한 EM 버전 16입니다."""
...
class EMV16PreprocessingPipeline(PreprocessingPipeline):
    ...
    def fit(self, features: pd.DataFrame, labels: pd.Series) -> "EMV16PreprocessingPipeline":
