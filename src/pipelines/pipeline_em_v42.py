"""em_v24와 em_v14을 중복 없이 결합한 EM v42."""
...
class EMV42PreprocessingPipeline(PreprocessingPipeline):
    """v24 기능에 v14에서 고유한 동의 변이 recurrent hotspot만 추가합니다."""
    ...
    def fit(self, features: pd.DataFrame, labels: pd.Series) -> "EMV42PreprocessingPipeline":
