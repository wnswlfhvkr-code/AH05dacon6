"""EMV16 기준선를 EMV16과 결합한 독립 실험 파이프라인입니다."""
...
class EME1PreprocessingPipeline(PreprocessingPipeline):
    """EMV16 기준선; 다른 버전 파이프라인을 상속하지 않습니다."""

    name = "em_E1"
    evaluation_folds = 5
    feature_spec = EMExperimentSpec(
        name="E1",
        description="EMV16 기준선",
