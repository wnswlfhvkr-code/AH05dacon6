"""EM G02: 고상관 그룹에서 fold 선택 안정성이 높은 피처를 유지합니다."""
...
class EMG02PreprocessingPipeline(PreprocessingPipeline):
    name = "em_G02"
    evaluation_folds = 5

    def __init__(self, **parameters: object) -> None:
        super().__init__()
        self.engine = EMV46RedundancyFilterEngine("g02_fold_stability", parameters)
