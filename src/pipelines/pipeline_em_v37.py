"""em_v16과 em_v14의 중복을 제거한 EM v37."""
...
class EMV37PreprocessingPipeline(PreprocessingPipeline):
    """v14 피처를 중복 생성하지 않고 v16의 OOF 개선형을 유지합니다."""
    ...
    def fit(self, features: pd.DataFrame, labels: pd.Series) -> "EMV37PreprocessingPipeline":
