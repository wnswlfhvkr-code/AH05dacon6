"""TEST_007용 class-balanced multinomial logistic regression GPU 모델입니다."""
...
def create_model(model_config: dict, seed: int) -> TorchTabularClassifier:
    """PyTorch 단일 선형층을 multinomial logistic regression으로 생성합니다."""
    return TorchTabularClassifier(
        hidden_dims=(),
        learning_rate=model_config.get("learning_rate", 3e-3),
        epochs=model_config.get("epochs", 80),
